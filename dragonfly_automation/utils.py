...
def interpolate_stage_positions(positions_filepath, region_shape, corner_positions, num_positions_per_well):
    ...
    for row_ind in range(num_rows):
        for col_ind in range(num_cols):
            ...
            # in the position_list generated by the plate-position plugin
            # This list begins at the top left corner,
            # then traverses the topmost row from right to left, 
...
def rename_tiff_stacks(positions_filepath, tiff_dirpath, logger=None):
    ...
    1) used stage positions generated by the plate-position plugin for MicroManager
